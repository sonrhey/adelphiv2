                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="commission_amount" value="<?php if(!is_null($loanamount)) echo $loanamount->commission_amount ?>" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label>Service Fee Amount</label>
                                    <input type="text" class="form-control" name="service_fee_amount" value="<?php if(!is_null($loanamount)) echo $loanamount->service_fee_amount ?>" readonly>
                                </div>
                                <div class="col-md-4">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="promi_note" value="<?php if(!is_null($loanamount)) echo $loanamount->promi_note ?>" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label>SPA</label>
                                    <input type="text" class="form-control" name="spa" value="<?php if(!is_null($loanamount)) echo $loanamount->spa ?>" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label>REM</label>
                                    <input type="text" class="form-control" name="rem" value="<?php if(!is_null($loanamount)) echo $loanamount->rem ?>" readonly>
                                </div>
                                <div class="col-md-3">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="appraisal" value="<?php if(!is_null($loanamount)) echo $loanamount->appraisal ?>" readonly>
                                </div>
                            </div>
                        </fieldset>
                        <div class="mb-3"></div>
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="chart_fee" value="<?php if(!is_null($loanamount)) echo $loanamount->chart_fee ?>" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label>Formulated fee</label>
                                    <input type="text" class="form-control" name="formulated_fee" value="<?php if(!is_null($loanamount)) echo $loanamount->formulated_fee ?>" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label>Fixed amount</label>
                                    <input type="text" class="form-control" name="fixed_amount" value="<?php if(!is_null($loanamount)) echo $loanamount->fixed_amount ?>" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label>Legal fees</label>
                                    <input type="text" class="form-control" name="legal_fee" value="<?php if(!is_null($loanamount)) echo $loanamount->legal_fee ?>" readonly>
                                </div>
                            </div>
                            <div class="mb-3"></div>
                            <div class="row">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="document_stamp" value="<?php if(!is_null($loanamount)) echo $loanamount->document_stamp ?>" readonly>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="relocation_fee" value="<?php if(!is_null($loanamount)) echo $loanamount->relocation_fee ?>" readonly>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            ...
                                            <input type="text" class="form-control" name="insurance" value="<?php if(!is_null($loanamount)) echo $loanamount->insurance ?>" readonly>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            <div class="col-md-3">
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md">
                                            <label>Taxes</label>
                                            <input type="text" class="form-control" name="taxes" value="<?php if(!is_null($loanamount)) echo $loanamount->taxes ?>" readonly>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
