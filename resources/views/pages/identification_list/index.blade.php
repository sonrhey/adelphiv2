@extends('layouts.app')
@section('title', 'Identification List')
    @section('content')
        <div class="card">
            <div class="card-body">
                <div class="container">
                    <a class="btn btn-success mb-5 float-right" href="{{URL('identification_list/create')}}">Add New</a>
                    <table class="table table-bordered datatables" id="tbl-identification-list">
                        <thead>
                            <tr>
                                <th>Code</th>
                                <th>Name</th>
...
@section('custom_js')
    ...
    <script src="{{ asset('js/pages/identification_list/index.js') }}"></script>
@endsection
