@extends('layouts.app')
@section('title', 'Add Client Family')
    @section('content')
        <div class="card">
            <div class="card-body">
                <div class="container">
                    <form method="POST" action="{{URL('clients/'.$client.'/family')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-sm-3 my-1">
                                ...
                                <select name="civil_status_id" required class="form-control">
                            ...
                            <div class="col-sm-3 my-1">
                                ...
                                <select name="client_relation_id" required class="form-control">
