...
@section('title', 'Nationality')
    @section('content')
        <div class="card">
            <div class="card-body">
                <div class="container">
                    <a class="btn btn-success mb-5 float-right" href="{{URL('nationality/create')}}">Add New</a>
                    <table class="table table-bordered datatables" id="tbl-nationality">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Action</th>
...
@section('custom_js')
    ...
    <script src="{{ asset('js/pages/nationality/index.js') }}"></script>
    <script>
        ...
        //         $('#to-delete').html(name);
        //         var a = '<form method="POST" action="nationality/'+id+'">'
        //             +'@csrf'
        //             +'@method("delete")'
